...
-device usb-host,bus=ehci2.0,hostbus=1,hostport=3,id=R-Port-2-usb2 \
...
-device usb-host,bus=ehci3.0,hostbus=1,hostport=4,id=R-Port-3-usb2 \
...
-device usb-host,bus=ehci4.0,hostbus=1,hostport=1,id=L-Port-usb2 \
